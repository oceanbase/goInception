...
var ErrorsDefault = map[ErrorCode]string{
	...
	ER_CANT_ADD_AUTO_INCREMENT_COLUMN:                    "[OceanBase Offline DDL Check]  Can't add AUTO_INCREMENT column '%s'.",
	ER_CANT_MODIFY_AUTO_INCREMENT_COLUMN:                 "[OceanBase Offline DDL Check]  Can't modify column '%s' to AUTO_INCREMENT.",
	ER_CANT_ADD_STORED_GENERATED_COLUMN:                  "[OceanBase Offline DDL Check]  Can't add stored generated column '%s'.",
	ER_CANT_MODIFY_PK_OR_UK_COLUMN:                       "[OceanBase Offline DDL Check]  Can't modify column '%s' to PK or UK.",
	ER_CANT_DROP_COLUMN:                                  "[OceanBase Offline DDL Check]  Can't drop column '%s'.",
	ER_CANT_DROP_PRIMARY_KEY:                             "[OceanBase Offline DDL Check]  Can't drop PRIMARY KEY '%s'.",
	ER_CANT_ADD_PRIMARY_KEY:                              "[OceanBase Offline DDL Check]  Can't add PRIMARY KEY '%s'.",
	ER_CANT_DROP_PARTITION:                               "[OceanBase Offline DDL Check]  Can't drop partition '%s'.",
	ER_CANT_TRUNCATE_PARTITION:                           "[OceanBase Offline DDL Check]  Can't truncate partition '%s'.",
	ER_CANT_ADD_COLUMNS_AND_CONSTRAINTS_IN_ONE_STATEMENT: "[OceanBase Offline DDL Check]  Can't add columns and constraints in one statement.",
}
...
var ErrorsChinese = map[ErrorCode]string{
	...
	ER_CANT_ADD_AUTO_INCREMENT_COLUMN:                    "[OceanBase Offline DDL Check]  禁止添加自增列 '%s'.",
	ER_CANT_MODIFY_AUTO_INCREMENT_COLUMN:                 "[OceanBase Offline DDL Check]  禁止修改列 '%s' 为AUTO_INCREMENT列.",
	ER_CANT_ADD_STORED_GENERATED_COLUMN:                  "[OceanBase Offline DDL Check]  禁止添加Stored生成列 '%s'.",
	ER_CANT_MODIFY_PK_OR_UK_COLUMN:                       "[OceanBase Offline DDL Check]  禁止修改列 '%s' 为 PK or UK列.",
	ER_CANT_DROP_COLUMN:                                  "[OceanBase Offline DDL Check]  禁止删除列 '%s'.",
	ER_CANT_DROP_PRIMARY_KEY:                             "[OceanBase Offline DDL Check]  禁止执行DROP PRIMARY KEY操作 '%s'.",
	ER_CANT_ADD_PRIMARY_KEY:                              "[OceanBase Offline DDL Check]  禁止执行ADD PRIMARY KEY操作 '%s'.",
	ER_CANT_DROP_PARTITION:                               "[OceanBase Offline DDL Check]  禁止删除分区 '%s'.",
	ER_CANT_TRUNCATE_PARTITION:                           "[OceanBase Offline DDL Check]  禁止清空分区 '%s'.",
	ER_CANT_ADD_COLUMNS_AND_CONSTRAINTS_IN_ONE_STATEMENT: "[OceanBase Offline DDL Check]  禁止在一条语句中同时添加列和约束.",
}
