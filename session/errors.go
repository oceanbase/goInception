...
var ErrorsDefault = map[ErrorCode]string{
	...
	ER_CANT_ADD_PK_OR_UK_COLUMN:            "\"OB-OFFLINE-DDL\" Can't add PK or UK column '%s'.",
	...
	ER_TABLE_CHARSET_MUST_NULL:             "\"OB-OFFLINE-DDL\" Not allowed set charset for table '%s'.",
	ErrTableCollationNotSupport:            "\"OB-OFFLINE-DDL\" Not allowed set collation for table '%s'.",
	...
	ErCantChangeColumnPosition:             "\"OB-OFFLINE-DDL\" Cannot change the position of the column '%s'.",
	...
	ER_CANT_ADD_AUTO_INCREMENT_COLUMN:                    "\"OB-OFFLINE-DDL\"  Can't add AUTO_INCREMENT column '%s'.",
	ER_CANT_MODIFY_AUTO_INCREMENT_COLUMN:                 "\"OB-OFFLINE-DDL\"  Can't modify column '%s' to AUTO_INCREMENT.",
	ER_CANT_ADD_STORED_GENERATED_COLUMN:                  "\"OB-OFFLINE-DDL\"  Can't add stored generated column '%s'.",
	ER_CANT_MODIFY_PK_OR_UK_COLUMN:                       "\"OB-OFFLINE-DDL\"  Can't modify column '%s' to PK or UK.",
...
var ErrorsChinese = map[ErrorCode]string{
	...
	ER_CANT_ADD_PK_OR_UK_COLUMN:                          "\"OB-OFFLINE-DDL\" 禁止添加主键或唯一键列 '%s",
	...
	ER_TABLE_CHARSET_MUST_NULL:                           "\"OB-OFFLINE-DDL\" 表 '%s' 禁止设置字符集!",
	ErrTableCollationNotSupport:                          "\"OB-OFFLINE-DDL\" 表 '%s' 禁止设置排序规则!",
	...
	ErCantChangeColumnPosition:                           "\"OB-OFFLINE-DDL\" 不允许改变列顺序(列'%s').",
	...
	ER_CANT_ADD_AUTO_INCREMENT_COLUMN:                    "\"OB-OFFLINE-DDL\"  禁止添加自增列 '%s'.",
	ER_CANT_MODIFY_AUTO_INCREMENT_COLUMN:                 "\"OB-OFFLINE-DDL\"  禁止修改列 '%s' 为AUTO_INCREMENT列.",
	ER_CANT_ADD_STORED_GENERATED_COLUMN:                  "\"OB-OFFLINE-DDL\"  禁止添加Stored生成列 '%s'.",
	ER_CANT_MODIFY_PK_OR_UK_COLUMN:                       "\"OB-OFFLINE-DDL\"  禁止修改列 '%s' 为 PK or UK列.",
